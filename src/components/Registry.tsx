        ...
        <tbody>
          {sorted.map((q) => {
            ...
            return (
              ...
              >
                <td className="whitespace-nowrap px-3 py-2.5 font-mono text-xs text-fog">
                  {dateShort(q.date)}
                ...
                <td className="whitespace-nowrap px-3 py-2.5 text-xs text-fog">{q.region}</td>
                ...
                <td className="whitespace-nowrap px-3 py-2.5 font-mono text-xs text-gold">
